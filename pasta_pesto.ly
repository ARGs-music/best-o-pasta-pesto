...
PartPTwoVoiceOneLyricsOne =  \lyricmode { "Mmm," "meow." "Mmm," "meow."
    ...
    the rest -- "o." \skip4 \skip4 \skip4 \skip4 \skip4 \skip4 \skip4
    \skip4 \skip4 \skip4 }
...
PartPThreeVoiceOneLyricsOne =  \lyricmode { "Mmm," "meow." "Mmm,"
    ...
    than the rest -- "o." \skip4 \skip4 \skip4 \skip4 \skip4 \skip4
...
PartPFiveVoiceOne =  \relative a' {
    ...
    \time 2/4  a4 \once \override NoteHead #'style = #'cross e'4 \bar
    "|."
    }
